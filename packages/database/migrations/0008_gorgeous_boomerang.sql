...
ALTER TABLE "profile_photos" ADD COLUMN "content_hash" varchar(64);--> statement-breakpoint
...
ALTER TABLE "payments" ADD CONSTRAINT "payments_target_profile_id_profiles_id_fk" FOREIGN KEY ("target_profile_id") REFERENCES "public"."profiles"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
CREATE INDEX "profile_photos_content_hash_idx" ON "profile_photos" USING btree ("profile_id","content_hash");--> statement-breakpoint
