...
export class AdminService {
  ...
  async getProfile(profileId: string) {
    ...
    return {
      ...
      childrenLivingWithMe: p.childrenLivingWithMe,
      subcaste: p.subcaste,
      gotra: p.gotra,
      ...
      diet: ls?.diet || null,
      familyType: fam?.familyType || null,
      familyStatus: fam?.familyStatus || null,
      familyValues: fam?.familyValues || null,
      fatherOccupation: fam?.fatherOccupation || null,
      motherOccupation: fam?.motherOccupation || null,
      ...
      prefHeightMinCm: pref?.prefHeightMinCm || null,
      prefHeightMaxCm: pref?.prefHeightMaxCm || null,
      prefReligions: pref?.prefReligions || [],
      prefMaritalStatuses: pref?.prefMaritalStatuses || [],
      prefCastes: pref?.prefCastes || [],
      prefMotherTongues: pref?.prefMotherTongues || [],
      prefLocations: pref?.prefLocations || [],
      prefMinEducation: pref?.prefMinEducation || null,
      prefAcceptableIncomes: pref?.prefAcceptableIncomes || [],
      completeness: calculateProfileCompleteness({
        profile: p,
        userPhone: u.phone,
        family: fam,
