  ...
  return useMutation({
    mutationFn: async (data: SignupData) => {
      ...
      const payload = {
        ...
        familyValues: (blank(data.familyValues) as any) || "Moderate",
        familyType: (blank(data.familyType) as any) || "Nuclear",
        fatherOccupation: (blank(data.fatherOccupation) as any) || "Employed",
        motherOccupation: (blank(data.motherOccupation) as any) || "Homemaker",
        brothersCount: data.brothersCount || 0,
        sistersCount: data.sistersCount || 0,
        diet: (blank(data.diet) as any) || "Vegetarian",
        smoking: (blank((data as any).smoking) as any) || "Never",
        alcohol: (blank((data as any).alcohol) as any) || "Never",
