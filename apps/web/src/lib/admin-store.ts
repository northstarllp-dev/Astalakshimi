...
function seedProfiles(): AdminProfile[] {
  ...
  return [
    base({
      ...
      phone: "9876543210",
      city: "Chennai",
      photos: photoSet(IMAGES.profiles.priya),
      verificationMethod: "selfie",
      verificationStatus: "pending",
      ...
      rashi: "Kanya",
      star: "Hasta",
      horoscopeName: "priya-horoscope.pdf",
    ...
    base({
      ...
      city: "Bengaluru",
      gender: "Female",
      photos: photoSet(IMAGES.profiles.ananya),
      verificationMethod: "govt_id",
      govtIdType: "Aadhaar",
      govtIdPhoto: IMAGES.profiles.ananya[1],
      verificationStatus: "pending",
    ...
    base({
      ...
      phone: "9876543212",
      city: "Coimbatore",
      photos: photoSet(IMAGES.profiles.shruti),
      verificationMethod: "selfie",
      verificationStatus: "pending",
      submittedAt: hoursAgo(2),
      selfiePhoto: IMAGES.profiles.shruti[0],
      birthTime: "08:15 AM",
      birthPlace: "Coimbatore",
      horoscopeName: "shruti-kundali.pdf",
      rashi: "Mesha",
      star: "Ashwini",
    }),
    base({
      ...
      phone: "9876543213",
      city: "Hyderabad",
      photos: photoSet(IMAGES.profiles.meera, "approved"),
      verificationMethod: "govt_id",
      govtIdType: "PAN card",
      govtIdPhoto: IMAGES.profiles.meera[1],
      verificationStatus: "verified",
      submittedAt: daysAgo(5),
      reviewedAt: daysAgo(4),
      reviewedBy: "Priya Admin",
      selfiePhoto: "",
      birthTime: "10:00 AM",
      birthPlace: "Hyderabad",
      horoscopeName: "meera.pdf",
      activeSubscription: true,
    }),
    base({
      id: "adm-005",
      ...
      phone: "9876543214",
      city: "Kochi",
      photos: photoSet(IMAGES.profiles.riya, "approved"),
      verificationMethod: "selfie",
      verificationStatus: "verified",
      submittedAt: daysAgo(10),
      reviewedAt: daysAgo(9),
      reviewedBy: "Ravi Moderator",
      selfiePhoto: IMAGES.profiles.riya[0],
      activeSubscription: true,
    }),
    base({
      id: "adm-006",
      ...
      gender: "Male",
      profileFor: "Myself",
      photos: photoSet([IMAGES.profiles.priya[0]], "rejected"),
      verificationMethod: "govt_id",
      govtIdType: "Driving licence",
      govtIdPhoto: IMAGES.profiles.ananya[2] ?? IMAGES.profiles.ananya[1],
      verificationStatus: "rejected",
      rejectionReason: "Government ID image is blurry and unreadable.",
    ...
    base({
      ...
      city: "Hyderabad",
      gender: "Male",
      photos: photoSet([IMAGES.profiles.shruti[0]]),
      verificationMethod: "govt_id",
      govtIdType: "Passport",
      govtIdPhoto: IMAGES.profiles.meera[0],
      verificationStatus: "pending",
    ...
    base({
      ...
      phone: "9876543217",
      city: "Chennai",
      photos: photoSet(IMAGES.profiles.priya.slice(0, 2), "approved"),
      verificationMethod: "selfie",
      verificationStatus: "verified",
    ...
    base({
      ...
      phone: "9876543218",
      city: "Madurai",
      photos: photoSet(IMAGES.profiles.ananya.slice(0, 2)),
      verificationMethod: "selfie",
      verificationStatus: "pending",
      submittedAt: hoursAgo(1),
      selfiePhoto: IMAGES.profiles.ananya[0],
    }),
    base({
      id: "adm-010",
      fullName: "Vikram S",
      ...
      gender: "Male",
      createdBy: "staff",
      createdByStaff: "Priya Admin",
      verificationStatus: "idle",
      verificationMethod: "",
      submittedAt: daysAgo(1),
      photos: photoSet([IMAGES.profiles.meera[0]]),
      aboutMe: "",
      selfiePhoto: "",
      completeness: 35,
    }),
    base({
      ...
      verificationMethod: "govt_id",
      govtIdType: "Voter ID",
      govtIdPhoto: IMAGES.profiles.riya[1],
      verificationStatus: "verified",
    ...
    base({
      ...
      verificationMethod: "govt_id",
      govtIdType: "Aadhaar",
      govtIdPhoto: IMAGES.profiles.shruti[1] ?? IMAGES.profiles.shruti[0],
      verificationStatus: "pending",
      submittedAt: hoursAgo(5),
      selfiePhoto: "",
      birthTime: "07:45 AM",
      birthPlace: "Mumbai",
      horoscopeName: "nisha-chart.pdf",
    }),
  ]
}
