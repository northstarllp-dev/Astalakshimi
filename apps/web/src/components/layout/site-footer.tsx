...
const columns = [
  {
    title: "Browse",
    links: [
      { href: "/register", label: "By religion" },
      { href: "/register", label: "By mother tongue" },
      ...
      <div className="mx-auto grid max-w-6xl gap-10 px-4 py-12 sm:grid-cols-2 lg:grid-cols-4">
        <div className="space-y-4">
          ...
          <p className="max-w-xs text-sm leading-relaxed text-white/70">
            South Indian-inspired design. Pan-India matchmaking for families who value community, privacy, and verified profiles.
          </p>
        </div>
        {columns.map((col) => (
          <div key={col.title}>
