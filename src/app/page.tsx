    ...
    <div className="flex min-h-dvh flex-col bg-background">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="md:hidden flex flex-col">
          ...
          <div className="relative h-[72vh] min-h-[420px] w-full">
            ...
            <div className="absolute bottom-0 inset-x-0 px-5 pb-7 space-y-1.5">
              <h1
              ...
              <p
                ...
                style={{ fontFamily: "var(--font-tiro), serif", letterSpacing: "0.06em" }}
              >
                உங்கள் வாழ்க்கை துணையை நம்பிக்கையுடன் தேடுங்கள்
              </p>
            </div>
          </div>
        ...
        <div className="relative hidden min-h-[760px] md:block">
          ...
          <div className="relative z-10 mx-auto flex w-full max-w-[96%] items-center justify-between gap-12 px-8 py-28">
            ...
            <div className="w-full max-w-lg space-y-8 text-white">
              {/* Tamil greeting with flanking lines */}
              <div className="flex items-center gap-4">
                <div className="h-px w-10 bg-gradient-to-r from-transparent to-secondary/60" />
                <p
                  className="text-lg tracking-[0.35em] text-secondary drop-shadow-lg"
                  style={{ fontFamily: "var(--font-tiro), serif", lineHeight: 1.6 }}
                >
                  வணக்கம்
                </p>
              ...
              {/* Tamil subtitle */}
              <p
                className="text-base leading-[1.9] text-secondary/75 drop-shadow"
                style={{ fontFamily: "var(--font-tiro), serif", letterSpacing: "0.08em" }}
              >
                உங்கள் வாழ்க்கை துணையை<br />
                நம்பிக்கையுடன் தேடுங்கள்
              </p>
      ...
      <section className="mx-auto max-w-6xl px-4 py-20">
        <div className="mx-auto max-w-2xl text-center mb-12">
          <p className="royal-label mb-2">Across the South</p>
          <h2 className="font-serif text-4xl font-bold md:text-5xl">From temple towns to tech cities</h2>
          <div className="ornament-line mx-auto mt-5 max-w-xs">
            <span className="text-secondary text-sm px-2">✦</span>
          </div>
          <p className="mt-5 text-sm text-muted-foreground md:text-base leading-relaxed">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {regions.map((region) => (
            <article key={region.name} className="group relative overflow-hidden rounded-2xl temple-frame cursor-pointer">
              <div className="relative h-52">
                ...
                <div className="absolute inset-x-0 bottom-0 p-5 text-white">
                  <h3 className="font-serif text-xl font-bold leading-tight">{region.name}</h3>
                  <p className="mt-0.5 text-xs text-white/70">{region.city}</p>
                </div>
                {/* Gold corner accent */}
                <div className="absolute top-3 right-3 h-5 w-5 border-t-2 border-r-2 border-secondary/60 rounded-tr-sm" />
                <div className="absolute bottom-3 left-3 h-5 w-5 border-b-2 border-l-2 border-secondary/60 rounded-bl-sm" />
              </div>
            </article>
          ))}
        </div>
      ...
      <section className="mx-auto max-w-6xl px-4 py-20">
        <div className="grid overflow-hidden rounded-3xl border border-secondary/25 bg-card shadow-lg md:grid-cols-2 temple-frame">
          ...
          <div className="flex flex-col justify-center space-y-5 p-8 md:p-12">
            ...
            <h2 className="font-serif text-3xl font-bold leading-tight">Woven like a Kanjivaram — community, faith, and family</h2>
      ...
      <section className="mx-auto max-w-6xl px-4 pb-20">
        <div className="grid items-center gap-10 overflow-hidden rounded-3xl bg-gradient-to-br from-[#2e0a0c] via-[#4f0f1a] to-primary p-8 text-white md:grid-cols-2 md:p-12">
          <div className="space-y-5">
            <p className="font-tamil text-sm tracking-[0.22em] text-secondary">நம்பிக்கை</p>
